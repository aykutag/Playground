...
namespace Sudoko
{
    ...
    public class SudokoTests
    {
        ...
        public void Solve()
        {
            var b = Solver.SolveSingleThreaded(new Board(4));

            b.Print();

            Assert.IsTrue(Util.Validate(b));
        }

        [Test]
        public void SolvePrepop()
        {
            var size = 81;
        ...
        private static IEnumerable<char> Boards
        {
            get
            {
                return @"
...
3...8.......7....51..............36...2..4....7...........6.13..452...........8.."
                    .Where(i => !System.Char.IsWhiteSpace(i));
            }
        }
